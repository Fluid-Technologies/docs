...
The **Utils API** (`fluide-utils`) provides cross-cutting platform services used by HR, Payroll, Pay, and Books: notifications, file storage, PDF and spreadsheet generation, and document jobs.
...
<Card title="Utils product guide" icon="wrench" href="/utils/overview">
  Modules, scopes, and suite integration points.
</Card>
