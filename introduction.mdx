...
<CardGroup cols={2}>
  <Card title="Get started" icon="rocket" href="/getting-started/authentication">
...
Use the **beta staging** gateway (`https://staging.api.fluidehr.com`) while integrating. Production URL will be announced at GA.
